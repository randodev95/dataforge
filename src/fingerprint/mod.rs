...
impl Fingerprinter {
    ...
    pub fn fingerprint(
        ...
        let rendered_sql = self.engine.render(raw_sql, &context, this_model, env_name, is_inc)
        ...
        let hash = TitanHasher::calculate(normalized_sql.as_str(), &config_json, parent_hashes, is_inc);
